...
//
//  Created by NicoRobine on 2020/8/27.
...
- (void)provideCredentialWithoutUserInteractionForIdentity:(ASPasswordCredentialIdentity *)credentialIdentity
{
    ...
    if (databaseIsUnlocked) {
        ASPasswordCredential *credential = [[ASPasswordCredential alloc] initWithUser:@"nicorobine" password:@"apple1234"];
...
{
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"failed" message:@"failed to get password credential identity" preferredStyle:UIAlertControllerStyleAlert];
